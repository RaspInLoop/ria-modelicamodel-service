...
public class SvgIconTest {
	...
	public void testBlockmath() throws IOException, XMLStreamException, ParseException, SAXException {
		...
		String svg = factory.build(Collections.singletonList(Icon.build(sr)),"");
	...
	@Test
	public void testLayeredModelicaDiagram() throws IOException, XMLStreamException, ParseException, SAXException {
